    ...
    \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    {
        /** @var $model Tutorial\SampleModel\Sample */
        ...
        $form->setHtmlIdPrefix('sample_content_');
        ...
        $this->_eventManager->dispatch('adminhtml_sample_edit_tab_content_prepare_form', ['form' => $form]);
