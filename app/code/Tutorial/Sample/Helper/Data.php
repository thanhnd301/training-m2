 ...
 * Sample data helper
 */
namespace Tutorial\Sample\Helper;
...
{
    /**
     * Path to store config where count of sample posts per page is stored
     *
     * @var string
     */
    const XML_PATH_ITEMS_PER_PAGE     = 'sample/view/items_per_page';
    ...
    /**
     * Remove Sample item image by image filename
     *
     ...
     * @return bool|string
     */
    public function resize(\Tutorial\Sample\Model\Sample $item, $width, $height = null)
    {
        if (!$item->getImage()) {
            return false;
        }
    ...
    /**
     * Return the base media directory for Sample Item images
     *
     * @return string
     */
    ...
    /**
     * Return the Base URL for Sample Item images
     *
     * @return string
     */
     ...
     * @return int
     */
    public function getSamplePerPage()
    {
